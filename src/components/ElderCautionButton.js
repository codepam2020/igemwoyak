...
import { ElderCautionAction } from '../actions';
...
/// function start
function ElderCautionButton({ content, style }) {
    ...
    <Container style={style}>
      ...
      <SwitchContainer>
        <Switch
          ...
          onValueChange={() => {
            const new_setting = { ElderCaution: !settingInfos.ElderCaution };
            dispatchSettingInfos({ ...settingInfos, ...new_setting });
            dispatch(ElderCautionAction());
            loadSettingInfos();
          }}
          value={settingInfos.ElderCaution}
          style={{
            marginLeft: 4,
            alignItems: 'center',
          }}
...
export default ElderCautionButton;

ElderCautionButton.defaultprops = {
  isEnabled: false,
};
